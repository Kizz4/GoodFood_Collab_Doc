# Architecture Option 3 - Dossier de synthèse

Ce dossier détaille la pile technologique retenue pour la trajectoire `Option 3 - hybride progressive`.

Contenu :
- `01_option3_technologies_et_justifications.md` : technologies retenues, rôle, justification et source.
- `02_decisions_de_coherence_et_ecarts.md` : écarts corrigés entre les documents techniques existants et le contexte GoodFood.
